...
import static jakthespire.JakTheSpire.characterPath;
...
public class TheSidekick extends CustomPlayer {
    ...
    private final Color cardRenderColor = JakTheSpire.marColor; //Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = JakTheSpire.marColor; //Used for card trail vfx during gameplay.
    private final Color slashAttackColor = JakTheSpire.marColor; //Used for a screen tint effect when you attack the heart.
    @Override
