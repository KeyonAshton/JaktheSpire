...
public class BlueMorphMode extends BaseCard {

    public static final String ID = makeID(BlueMorphMode.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        ...
        if (this.upgraded) {
            addToBot(new ApplyPowerAction(p, p, new ArcWielder(p, 1), 1));
        } else {
            addToBot(new ApplyPowerAction(p, p, new VulcanFury(p, 1), 1));
        }
    }
}
