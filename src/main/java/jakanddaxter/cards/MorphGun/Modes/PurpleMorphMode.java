...
public class PurpleMorphMode extends BaseCard {

    public static final String ID = makeID(PurpleMorphMode.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        ...
        if (this.upgraded) {
            addToBot(new ApplyPowerAction(p, p, new SuperNova(p, 1), 1));
        } else {
            addToBot(new ApplyPowerAction(p, p, new PeaceMaker(p, 1), 1));
        }
    }
}
