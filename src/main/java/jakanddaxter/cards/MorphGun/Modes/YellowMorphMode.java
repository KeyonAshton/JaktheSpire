...
public class YellowMorphMode extends BaseCard {

    public static final String ID = makeID(YellowMorphMode.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        ...
        if (this.upgraded) {
            addToBot(new ApplyPowerAction(p, p, new BeamReflexor(p, 1), 1));
        } else {
            addToBot(new ApplyPowerAction(p, p, new Blaster(p, 1), 1));
        }
    }
}
