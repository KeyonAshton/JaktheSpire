...
public class YellowAmmoCard extends BaseCard {
    public static final String ID = makeID(YellowAmmoCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(p, p, new YellowAmmoPower(p, 1), 1));
    }
}
