package jakanddaxter.cards.forms;
...
public class LightForm extends BaseCard {

    public static final String ID = makeID(LightForm.class.getSimpleName());
