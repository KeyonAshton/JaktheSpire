...
public class RedEcoCard extends BaseCard {

    public static final String ID = makeID(RedEcoCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster abstractMonster) {
        if (timesUpgraded < 2) {
            addToBot(new ApplyPowerAction(p, p, new RedEcoPower(p, 1), this.magicNumber));
        } else {
