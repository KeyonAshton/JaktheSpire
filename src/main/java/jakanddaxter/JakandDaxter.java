...
import jakanddaxter.relics.BaseRelic;
import jakanddaxter.util.GeneralUtils;
import jakanddaxter.util.KeywordInfo;
import jakanddaxter.util.TextureLoader;
...
@SpireInitializer
public class JakandDaxter implements
    ...
    private static final String resourcesFolder = "jakanddaxter";
...
//    private static final Color ottselColor = new Color(255f/255f, 156f/255f, 1f/255f, 1f);
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(jakanddaxter.JakandDaxter.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
